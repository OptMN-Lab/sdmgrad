...
# sdmgrad
common_parser.add_argument("--lamda", type=float, default=0.3, help="lambda for SDMGrad alg.")
common_parser.add_argument("--niter", type=int, default=20, help="niter for SDMGrad alg.")
# famo
...
def extract_weight_method_parameters_from_args(args):
    ...
    weight_methods_parameters.update(
        dict(
            ...
            sdmgrad=dict(lamda=args.lamda, niter=args.niter, max_norm=args.max_norm),
